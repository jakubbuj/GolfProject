...
public class SettingsScreen implements Screen {
    ...
    // method for handling the submit button. Updates variables: InitialX, InitialY, terrainFunction, grassK, grassS, sandK, sandS, TargetXo, TargetYo
    ...
    // method for handling the default button. It sets all the variables used in physics engine to default.
    public void handleDefaultButton() {
        ...
        defaultButton.addListener(new ClickListener() {
            ...
            function.setText(" sqrt ( ( sin x + cos y ) ^ 2 )");
